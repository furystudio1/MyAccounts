...
public class DialogAppWeb {
    ...
    public DialogAppWeb(CreditCard var1) {
    ...
    private void initDialogButtons() {
        ...
        this.bt_cancel.setOnClickListener(new OnClickListener() {
            public void onClick(View var1) {
                ...
                DialogAppWeb.this.mDialog.dismiss();
    ...
    public void showDialog() {
        ...
        this.mDialog.setContentView(R.layout.dialog_webapp);
